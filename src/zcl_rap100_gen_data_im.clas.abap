CLASS zcl_rap100_gen_data_im DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_IM IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'IM',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_im.
    DELETE FROM zrp100_atrv_im_d.

    "insert travel demo data
    INSERT zrap100_atrav_im  FROM (
        SELECT
